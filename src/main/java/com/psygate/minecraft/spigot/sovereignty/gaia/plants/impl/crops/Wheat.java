 ...
 */
public class Wheat extends ACrop {
    public Wheat(GrowthHandler handler) {
        this("wheat", handler);
    }
    ...
    private Wheat(String carrot, GrowthHandler handler) {
        super(handler, carrot, new ItemStack[]{new ItemStack(Material.SEEDS)}, Material.CROPS);
    }
}
