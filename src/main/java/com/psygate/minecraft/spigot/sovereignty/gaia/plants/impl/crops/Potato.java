 ...
 */
public class Potato extends ACrop {
    public Potato(GrowthHandler handler) {
        this("potato", handler);
    }
    ...
    private Potato(String carrot, GrowthHandler handler) {
        super(handler, carrot, new ItemStack[]{new ItemStack(Material.POTATO_ITEM)}, Material.POTATO);
    }
}
