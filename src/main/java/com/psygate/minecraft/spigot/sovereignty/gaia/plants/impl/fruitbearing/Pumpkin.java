 ...
 */
public class Pumpkin extends APlant {
    public Pumpkin(GrowthHandler handler) {
        this("pumpkin", handler);
    }
    ...
    private Pumpkin(String carrot, GrowthHandler handler) {
        super(handler, carrot, new ItemStack[]{new ItemStack(Material.PUMPKIN_SEEDS)},
                IntStream.range(0, 8).mapToObj(v -> new MaterialType(Material.PUMPKIN_STEM, v)).toArray(MaterialType[]::new)
        );
    }
}
