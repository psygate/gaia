 ...
 */
public class BrownMushroom extends APlant {
    public BrownMushroom() {
        this(new MushroomGrowthHandler());
    }

    public BrownMushroom(GrowthHandler ghandler) {
        super(ghandler, "brownmushroom", new ItemStack[]{new ItemStack(Material.BROWN_MUSHROOM)}, new MaterialType[]{new MaterialType(Material.BROWN_MUSHROOM, 0)});
    }
}
