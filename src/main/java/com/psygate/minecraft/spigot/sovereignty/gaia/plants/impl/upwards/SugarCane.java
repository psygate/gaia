 ...
 */
public class SugarCane extends APlant {
    public SugarCane() {
        this(new UpwardsHandler());
    }

    public SugarCane(GrowthHandler handler) {
        this(handler, "sugarcane");
    }

    private SugarCane(GrowthHandler ghandler, String name) {
        super(ghandler, name, new ItemStack[]{new ItemStack(Material.SUGAR_CANE)}, new MaterialType[]{new MaterialType(Material.SUGAR_CANE_BLOCK, 0)});
    }
}
